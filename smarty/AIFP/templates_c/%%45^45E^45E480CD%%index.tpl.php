<?php /* Smarty version 2.6.30, created on 2016-11-23 13:47:14
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li><a href="left-sidebar.html">Regolamenti</a></li>
									<li><a href="right-sidebar.html">Eventi</a></li>
			...
			<!-- Banner -->
				<div id="banner">
					<section class="container">
						<h2>AIFP</h2>
						<span>Associazione Italiana Funghi & Piante</span>
                                                <p>Il piacere di trovare un fungo sta nel coglierlo nascosto nel suo angolo del bosco: un’emozione neppure lontanamente paragonabile al momento in cui si vede un paniere di funghi in vendita.</p>
                                                    
                                                <p class="cit">Carlo Lapucci, Dizionario dei proverbi italiani, 2006
                                                </p>
					</section>
				</div>
